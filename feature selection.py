...
selected_features = X.columns[feature_importances > 0]  # Select features with non-zero importances

# Update the feature set with the selected features
